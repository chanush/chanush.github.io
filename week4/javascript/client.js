...
function init() {
    let letsCount = document.getElementById("letsCount");
    letsCount.addEventListener("click", sign_out);
    // let span = document.getElementsByClassName("span");
    // span.addEventListener("click", );

    // let button1 = document.getElementById("submit_sign_in");
    // button1.addEventListener("click", submitSignin);
    // let button2 = document.getElementById("submit_log");
    // button2.addEventListener("click", submitLog);
    // document.getElementById("newmessage").addEventListener('click', open_text);
    // document.getElementById("currentlist").addEventListener('click', current_list);
}
let user = {
    username: '',
    password: '',
...
function infoOnClick(){
    ...
    <div>
        ...
        <p>.כל המומלצים הם בגדר חובה*</p>
        <p>.אזהרה למשתמש: האתר עשוי להכיל תכנים הגורמים לצחוק רב. אנא שמרו על ערנותכם**</p>
         </div>`
    element.innerHTML =inethtml;
...
function date_has_not_passed(today,pressed_date){
    ...
    let random_number=Math.floor(Math.random() * 30)%7;
...
function span(num) {
    ...
    if (date > today) { //date has not passed yet
...
function sign_out() {
    // let secet = document.getElementById("current_list");
    // secet.innerHTML = "";
    // user.current_user = '';
    // user.password = '';
    // user.username = '';
